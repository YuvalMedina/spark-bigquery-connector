  ...
  public Optional<DataSourceWriter> createWriter(
    ...
    Injector injector =
        Guice.createInjector(
            ...
            new SparkBigQueryConnectorModule(spark, options, schema, mode, writeUUID));

    BigQueryInsertAllDataSourceWriter writer =
        injector.getInstance(BigQueryInsertAllDataSourceWriter.class);
